...
class TestPlatformBaseConfig(unittest.TestCase):
    ...
    def test_analytics_from_dict(self):
        ...
        self.assertEqual(analytics.rawmemberactivities_condition, {"thread_id": {"$ne": None}})
    ...
    def test_analytics_data_from_dict(self):
        ...
        self.assertEqual(heatmaps_config.hourly_analytics[0].direction, ActivityDirection.EMITTER)
        self.assertFalse(heatmaps_config.hourly_analytics[0].member_activities_used)
        self.assertEqual(heatmaps_config.hourly_analytics[0].rawmemberactivities_condition, {"thread_id": {"$ne": None}})
        ...
        self.assertEqual(heatmaps_config.raw_analytics[0].direction, ActivityDirection.RECEIVER)
